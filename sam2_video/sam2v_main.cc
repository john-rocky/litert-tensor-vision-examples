...
//   bazel build --config=macos //tensor/examples/sam2_video:sam2v_main
...
#include "tensor/examples/sam2_image/sam2_weights.h"
#include "tensor/examples/sam2_video/sam2v_graph.h"
#include "tensor/examples/sam2_video/sam2v_weights.h"
